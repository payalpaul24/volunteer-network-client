...
const Register = () => {
	...
	const selectedEvent = eventData.find((item) => item._id == _id);
			...
			<div className="vn-login-register register p-md-5 p-4">
				...
				<form action="/registerVolunteer" onSubmit={handleSubmitTask}>
					<div className="form-group">
						<input type="text" className="form-control w-75" placeholder="Full Name" name="name" value={volunteer.name} onChange={handleInputValue} required={true} minLength="3"/>
					</div>
					<div className="form-group">
						<input type="email" className="form-control" placeholder="Username or Email" name="email" value={volunteer.email} onChange={handleInputValue} disabled={true}/>
					</div>
					<div className="form-group">
						<input
							type="date"
					...
					<div className="form-group">
						<input
							...
							name="title"
							value={selectedEvent ? selectedEvent.title : "Please pick a task from home page"}
							onChange={handleInputValue}
							disabled={true}
						/>
					</div>
